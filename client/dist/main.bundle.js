...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_ReplaySubject__ = __webpack_require__("../../../../rxjs/_esm2015/ReplaySubject.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let CommonService = class CommonService {
    constructor(httpCient) {
        this.httpCient = httpCient;
        this.currentDateSubject = new __WEBPACK_IMPORTED_MODULE_4_rxjs_ReplaySubject__["a" /* ReplaySubject */](1);
        this.gridSubject = new __WEBPACK_IMPORTED_MODULE_4_rxjs_ReplaySubject__["a" /* ReplaySubject */](1);
    }
    setCurrentDate(date) {
        // this.currentDate = date;
    ...
    fillTable() {
        ...
        this.httpCient.get(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].api + 'api/table/get_tables').subscribe(tableData => {
            ...
            this.currentDateSubject.subscribe(date => {
                ...
                tables.forEach(table => {
                    ...
                    this.httpCient.get(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].api + 'api/table/get_table_reservations/' + table['id'] + '/' + date)
                        .subscribe(tableReservation => {
                        console.log('service - http - get_table_reservations- result - ', tableReservation);
                        tableProcessedCount++;
                        tr.push({
                            tableId: +table['id'],
                            slot: Array(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].closing - __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening).fill({}).map((val, index) => ({
                                'start': __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening + index,
                                'end': __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening + index + 1,
                                'reservation_id': 0
                            })).map(slot => {
    ...
    getOpenHours() {
        return Array(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].closing - __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening).
            fill(0).map((x, i) => {
            return {
                start: {
                    value: i + __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening,
                    display: (i + __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening).toString() + ':00'
                },
                end: {
                    value: i + __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening + 1,
                    display: (i + __WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].opening + 1).toString() + ':00'
                }
            };
        });
    }
...
let CreateReservationComponent = class CreateReservationComponent {
    ...
    ngOnInit() {
        this.openHours = this.commonService.getOpenHours();
        this.reservation = new __WEBPACK_IMPORTED_MODULE_6__models_Reservation__["c" /* Reservation */]('', new __WEBPACK_IMPORTED_MODULE_6__models_Reservation__["a" /* Attributes */](new Date(0, 0), 0, 0, 0, 0, '', new __WEBPACK_IMPORTED_MODULE_6__models_Reservation__["b" /* ContactDetails */]('', ''), [''], ''));
        this.reservationTypes = __WEBPACK_IMPORTED_MODULE_5__constants__["b" /* ReservationTypes */];
        this.showReservationForm = false;
        this.tags = __WEBPACK_IMPORTED_MODULE_5__constants__["e" /* Tags */].map((tag, i) => {
            return { name: tag, value: i, checked: false };
        });
        this.statuses = __WEBPACK_IMPORTED_MODULE_5__constants__["d" /* Statuses */];
        this.httpCient.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/table/get_tables').subscribe(data => {
        ...
        if (Object.keys(this.data).length != 0) {
            ...
            this.httpCient.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/table/get_table/' + tableId).subscribe(data => {
    ...
    onReservationSubmit() {
        this.httpCient.post(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/reservation/add_reservation', this.reservationForm.value).subscribe(data => {
            console.log(data);
    ...
    update() {
        this.httpCient.put(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/reservation/update_reservation/' +
    ...
    delete() {
        this.httpCient.delete(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/reservation/delete_reservation/' +
...
CreateReservationComponent = __decorate([
    ...
    __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* Inject */])(__WEBPACK_IMPORTED_MODULE_8__angular_material__["a" /* MAT_DIALOG_DATA */])),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__angular_common__["c" /* DatePipe */],
        __WEBPACK_IMPORTED_MODULE_7__common_service__["a" /* CommonService */], __WEBPACK_IMPORTED_MODULE_8__angular_material__["e" /* MatDialogRef */],
        __WEBPACK_IMPORTED_MODULE_6__models_Reservation__["c" /* Reservation */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormBuilder */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__create_reservation_create_reservation_component__ = __webpack_require__("../../../../../src/app/create-reservation/create-reservation.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_Table__ = __webpack_require__("../../../../../src/app/models/Table.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__models_Reservation__ = __webpack_require__("../../../../../src/app/models/Reservation.ts");
...
let HeaderComponent = class HeaderComponent {
    ...
    ngOnInit() {
        ...
        this.commonService.fillTable();
        this.table = new __WEBPACK_IMPORTED_MODULE_8__models_Table__["a" /* Table */]('', 0);
        this.sections = __WEBPACK_IMPORTED_MODULE_6__constants__["c" /* Sections */];
        this.capacities = __WEBPACK_IMPORTED_MODULE_6__constants__["a" /* Capacities */];
        this.showAddTableForm = false;
        this.httpCient.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].api + 'api/table/get_tables').subscribe(data => {
            this.tableList = data['tables'].map(table => (table['id']));
        });
    }
    prev() {
    ...
    onTableSubmit() {
        if (this.table.section != '' && this.table.capacity != 0) {
            this.httpCient.post(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].api + 'api/table/add_table', this.table).subscribe(data => {
                console.log(data);
                this.commonService.fillTable();
            }, err => console.log(err));
            this.table = new __WEBPACK_IMPORTED_MODULE_8__models_Table__["a" /* Table */]('', 0);
    ...
    openDialog() {
        let dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_7__create_reservation_create_reservation_component__["a" /* CreateReservationComponent */], {
            width: __WEBPACK_IMPORTED_MODULE_4__config__["a" /* config */].reservationFormWidth,
            height: __WEBPACK_IMPORTED_MODULE_4__config__["a" /* config */].reservationFormHeight,
            data: { "from": "header", "data": new __WEBPACK_IMPORTED_MODULE_9__models_Reservation__["c" /* Reservation */]('', new __WEBPACK_IMPORTED_MODULE_9__models_Reservation__["a" /* Attributes */](new Date(this.currentDate), 0, 0, 0, 0, '', new __WEBPACK_IMPORTED_MODULE_9__models_Reservation__["b" /* ContactDetails */]('', ''), [''], '')) }
        });
...
HeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__angular_common__["c" /* DatePipe */],
        __WEBPACK_IMPORTED_MODULE_10__common_service__["a" /* CommonService */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["c" /* MatDialog */]])
], HeaderComponent);
...
let TileComponent = class TileComponent {
    ...
    populateTile(id) {
        this.httpCient.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].api + 'api/reservation/get_reservation/' + id).subscribe(data => {
...
TileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_material__["c" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */],
        __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_6__common_service__["a" /* CommonService */]])
], TileComponent);
